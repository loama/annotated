  ...
  return (
    <main className="mx-auto min-h-[100dvh] max-w-4xl px-4 pb-24 pt-12 md:px-7 md:pb-32 md:pt-20">
      ...
      <div className="divide-y divide-[var(--line)]">
        {[
          { title: "Chrome extension", body: "The extension accesses the active tab only when you click the Annotated toolbar icon. It reads the current URL, page title, selected text, and current media time, then transfers those details directly into the embedded studio in your browser. When you publish a YouTube annotation, an extension-owned confirmation asks you to start recording. It then records the fully visible player area and tab audio only for your selected range, up to 90 seconds, and uploads that recording for exact-range 240p encoding. It does not read or store YouTube cookies. Its access to annotated-beta.vercel.app lets the studio use your existing secure session. Chrome asks for microphone access only if you choose to record commentary. The extension does not collect browser history or monitor pages in the background." },
