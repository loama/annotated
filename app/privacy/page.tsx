  ...
  return (
    <main className="mx-auto min-h-[100dvh] max-w-4xl px-4 pb-24 pt-12 md:px-7 md:pb-32 md:pt-20">
      ...
      <div className="divide-y divide-[var(--line)]">
        {[
          { title: "Chrome extension", body: "The extension accesses the active tab only when you open Annotated or press recapture. It reads the current URL, page title, selected text, and current media time so it can prepare an annotation draft. It does not collect browser history or monitor pages in the background." },
